...
<form name="cadastrartipocampanha" action="TipoCampanhaCadastrar"
    ...
    <table align="center" border="0">
        ...
        <tbody>
            ...
            <tr><td>Nome: </td>
                <td><input type="text" name="nometipocampanha" id="nometipocampanha"
                           value="${tipocampanha.nomeTipoCampanha}"/></td></tr>
            <tr><td>Descricao: </td>
                <td><input type="text" name="descricaotipocampanha" id="descricaotipocampanha"
                           value="${tipocampanha.descricaoTipoCampanha}"/></td></tr>
